...
A modern and efficient Android application designed to help university students manage courses, schedules, assignments, reminders, and academic commitments from a single, organized platform. The application includes multilingual support with English, Portuguese, and Spanish localization, providing an accessible and user-friendly experience for a diverse academic community.
...
The application supports English, Portuguese, and Spanish, automatically adapting to the device language settings to provide a seamless experience for users from different regions.
